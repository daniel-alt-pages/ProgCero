...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function speak(text) {
        if (isMuted || !text || synth.speaking) return;
    ...
    if (startExperienceButton) {
        startExperienceButton.addEventListener('click', () => {
            ...
            speak("¡Hola, futuro colega! Te doy la bienvenida a ProgCero, la plataforma donde tu viaje para convertirte en un gran programador comienza. Esperamos que disfrutes toda la información e interacción en esta página. Querido usuario, te recuerdo que ya abrimos las inscripciones de nuestro curso de programación, puedes inscribirte dandole clic al boton de whatsapp de la esquina inferior derecha.");
        });
    }
